...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './parcour.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PARCOUR_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PARCOUR actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PARCOUR actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PARCOUR actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PARCOUR actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PARCOUR actions', async () => {
      const arg = 42666;
