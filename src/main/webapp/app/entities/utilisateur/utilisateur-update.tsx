  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="findelecApp.utilisateur.home.createOrEditLabel" data-cy="UtilisateurCreateUpdateHeading">
            <Translate contentKey="findelecApp.utilisateur.home.createOrEditLabel">Create or edit a Utilisateur</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('findelecApp.utilisateur.nom')}
                id="utilisateur-nom"
                name="nom"
                data-cy="nom"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('findelecApp.utilisateur.prenom')}
              ...
              />
              <ValidatedField
                label={translate('findelecApp.utilisateur.email')}
              ...
              />
              <ValidatedField
                label={translate('findelecApp.utilisateur.motDePasse')}
