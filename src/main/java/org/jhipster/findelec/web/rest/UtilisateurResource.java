...
/**
 * REST controller for managing {@link org.jhipster.findelec.domain.Utilisateur}.
 */
@RestController
...
public class UtilisateurResource {
    ...
    public Mono<ResponseEntity<Utilisateur>> partialUpdateUtilisateur(
        ...
        return utilisateurRepository
            ...
            .flatMap(exists -> {
                ...
                Mono<Utilisateur> result = utilisateurRepository
    ...
    public Mono<List<Utilisateur>> getAllUtilisateurs() {
        ...
        return utilisateurRepository.findAll().collectList();
    }
    ...
    public Mono<ResponseEntity<Utilisateur>> getUtilisateur(@PathVariable("id") Long id) {
        ...
        Mono<Utilisateur> utilisateur = utilisateurRepository.findById(id);
